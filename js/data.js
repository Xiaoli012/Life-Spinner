...
// 每条 {text, author?}；author 缺省表示是无名鸡汤
const QUOTES = [
  // —— 名人名言：意义/活法 ——
  {text:'未经审视的人生不值得过', author:'苏格拉底'},
  {text:'我们就是我们重复在做的事，因此卓越不是行为，而是习惯', author:'亚里士多德'},
  {text:'生命不在于活了多少日子，而在于记住了多少日子', author:'马克·吐温'},
  {text:'人生最大的快乐，是做别人说你做不到的事', author:'白哲特'},
  {text:'你这一生，最坏的情况无非就是大器晚成', author:'罗振宇'},
  {text:'人生不是要超越别人，而是要超越昨天的自己', author:'宫崎骏'},
  {text:'有些路，看起来很近，走起来却很远，缺少耐心，永远走不到尽头', author:'三毛'},
  {text:'我们终其一生，就是要摆脱他人的期待，找到真正的自己', author:'《无声告白》'},
  {text:'生活在阴沟里，依然有仰望星空的权利', author:'王尔德'},
  {text:'如果你不出去走走，你会以为这就是世界', author:'高更'},
  {text:'生活的真谛在于发现自己的天赋，人生的目的在于使用它', author:'毕加索'},
  {text:'此心安处是吾乡', author:'苏轼'},
  {text:'此身、此时、此地', author:'王阳明'},
  {text:'结庐在人境，而无车马喧。问君何能尔，心远地自偏', author:'陶渊明'},
  {text:'世界上只有一种英雄主义，就是看清生活的真相之后依然热爱生活', author:'罗曼·罗兰'},
  {text:'不是因为有了希望才坚持，而是因为坚持了才有希望', author:'胡适'},
  {text:'迟早有一天你会发现，真正持久的快乐是来自内在的安宁', author:'稻盛和夫'},

  // —— 名人名言：行动/勇气 ——
  {text:'求知若饥，虚心若愚', author:'乔布斯'},
  {text:'你的时间有限，别浪费在重复别人的人生上', author:'乔布斯'},
  {text:'想象力比知识更重要', author:'爱因斯坦'},
  {text:'人生而自由，却无往不在枷锁之中', author:'卢梭'},
  {text:'通往地狱的道路，是由善意铺成的', author:'圣伯纳德'},
  {text:'勇敢不是不害怕，而是即便害怕仍去行动', author:'纳尔逊·曼德拉'},
  {text:'走得最慢的人，只要不丢失目标，也比漫无目的徘徊的人走得快', author:'莱辛'},
  {text:'种一棵树最好的时间是十年前，其次是现在', author:'非洲谚语'},
  {text:'我们只活一次，但活得好，一次就够了', author:'梅·韦斯特'},
  {text:'最大的冒险就是不去冒险', author:'马克·扎克伯格'},

  // —— 名人名言：时间/慢 ——
  {text:'人不能两次踏进同一条河流', author:'赫拉克利特'},
  {text:'光阴者，百代之过客也', author:'李白'},
  {text:'吾生也有涯，而知也无涯', author:'庄子'},
  {text:'明日复明日，明日何其多', author:'钱福'},
  {text:'人就是要学着自己跟自己玩', author:'蔡康永'},
  {text:'生活就像一盒巧克力，你永远不知道下一颗是什么味道', author:'《阿甘正传》'},
  {text:'生命中最幸福的就是和你爱的人吃饭', author:'《饮食男女》'},

  // —— 鸡汤：日常/治愈 ——
  {text:'真正的丰盛，不是塞满时间，而是把时间放在对的事上'},
  {text:'日复一日的小事，决定了你是谁'},
  {text:'记录，是给未来的自己留的信'},
  {text:'让今天比昨天多一点点意义'},
  {text:'把时间给爱的人和爱的事'},
  {text:'和孩子一起做的事，十年后还在记得'},
  {text:'人生不是要过得快，是要过得深'},
  {text:'你最珍贵的不是经历，是你在经历里成为的那个人'},
  {text:'方向比速度重要，不慌不忙的人，活得最快'},
  {text:'你不是没时间，是没排序'},
  {text:'一个能被规划的生活，才有自由可言'},
  {text:'今天的安排，是对昨天思考的兑现'},
  {text:'无聊是创造的母亲，给空白留点位置'},
  {text:'选不出来的时候，让运气替你做决定'},
  {text:'换条路走走，世界就大了一圈'},
  {text:'灵感不会等你，它只在你出门的时候出现'},
  {text:'今天试一件没做过的小事'},
  {text:'刻意练习，积少成多'},
  {text:'慢慢来，比较快'},
  {text:'完成胜过完美'},
  {text:'先做五分钟，再决定要不要继续'},
  {text:'你不需要赢过所有人，只需要超过昨天的自己'},
  {text:'今天好好吃饭，好好睡觉，好好抱抱家人'},
  {text:'多走两步路，多问一句话，多笑一次'},
  {text:'枯燥的日子里，给自己留一束光'},
  {text:'生活的诗意，藏在那些不被打扰的清晨里'},
  {text:'阳台上的一盆花，也能撑起一个春天'},
  {text:'熬过去的，都成了故事；熬不过的，都成了事故'},
  {text:'当你觉得为时已晚的时候，恰恰是最早的时候'},
  {text:'别让 30 岁的你，做 20 岁的你后悔的事'},
  {text:'你眼里的平凡，是别人羡慕的生活'},
  {text:'重复的日子，只有自己能赋予它意义'},
  {text:'今天是你余生中最年轻的一天'},
  {text:'累的时候，记得抬头看看月亮'},
  {text:'人生不是轨道，是旷野'},
  {text:'你过的每一关，都是为更好的自己铺路'},
  {text:'平凡也是一种了不起'},
  {text:'活着不是用来证明什么，是用来感受什么'},
  {text:'生活总是在拐角处，给你一个意外的礼物'},
  {text:'有人 24 岁退休，有人 64 岁开始；时间从不晚'},
...
const CATEGORY_RESOURCES = {
  reflect: [
    {emoji:'🧘', name:'Calm',           desc:'冥想引导 + 睡眠故事',      url:'https://www.calm.com',
      scheme:'calm://', appStore:'https://apps.apple.com/app/id571800810', playStore:'https://play.google.com/store/apps/details?id=com.calm.android'},
    {emoji:'🌬️', name:'潮汐 Tide',       desc:'呼吸 / 专注 / 助眠',      url:'https://tide.fm',
      scheme:'tide://', appStore:'https://apps.apple.com/app/id1077776989', playStore:'https://play.google.com/store/apps/details?id=com.moreless.tide'},
    {emoji:'📓', name:'Day One',        desc:'日记 App',                 url:'https://dayoneapp.com',
      scheme:'dayone://', appStore:'https://apps.apple.com/app/id1044867788', playStore:'https://play.google.com/store/apps/details?id=com.dayoneapp.dayone'},
    {emoji:'🎵', name:'Lofi 冥想歌单',   desc:'Spotify',                  url:'https://open.spotify.com/playlist/0vvXsWCC9xrXsKd4FyS8kM',
      scheme:'spotify:playlist:0vvXsWCC9xrXsKd4FyS8kM', appStore:'https://apps.apple.com/app/id324684580', playStore:'https://play.google.com/store/apps/details?id=com.spotify.music'},
    {emoji:'🔁', name:'5 分钟内省流程',  desc:'呼吸 3min → 3 件感恩 → 今日最满意一刻 → 明天 1 个小目标'},
  ],
  reading: [
    {emoji:'📖', name:'微信读书',        desc:'中文电子书 + 划线笔记',    url:'https://weread.qq.com',
      scheme:'weread://', appStore:'https://apps.apple.com/app/id984143714', playStore:'https://play.google.com/store/apps/details?id=com.tencent.weread'},
    {emoji:'📚', name:'Kindle',          desc:'英文电子书',              url:'https://read.amazon.ae',
      scheme:'kindle://', appStore:'https://apps.apple.com/app/id302584613', playStore:'https://play.google.com/store/apps/details?id=com.amazon.kindle'},
    {emoji:'⭐', name:'Goodreads',       desc:'书单 + 朋友推荐',         url:'https://www.goodreads.com',
      appStore:'https://apps.apple.com/app/id355833469', playStore:'https://play.google.com/store/apps/details?id=com.goodreads'},
    {emoji:'🎧', name:'喜马拉雅',        desc:'听书，通勤/散步用',       url:'https://www.ximalaya.com',
      scheme:'iting://', appStore:'https://apps.apple.com/app/id552465490', playStore:'https://play.google.com/store/apps/details?id=com.ximalaya.ting.android'},
    {emoji:'🔁', name:'番茄读书法',      desc:'25 min 专注 → 5 min 写一句话笔记'},
  ],
  cooking: [
    {emoji:'🍳', name:'下厨房',          desc:'中文菜谱第一',            url:'https://www.xiachufang.com',
      appStore:'https://apps.apple.com/app/id465478001', playStore:'https://play.google.com/store/apps/details?id=com.xiachufang.lazycook'},
    {emoji:'🎬', name:'YouTube · 王刚',  desc:'家常菜视频步骤',          url:'https://www.youtube.com/@SichuanCuisinemaster',
      scheme:'youtube://', appStore:'https://apps.apple.com/app/id544007664', playStore:'https://play.google.com/store/apps/details?id=com.google.android.youtube'},
    {emoji:'🛒', name:'Carrefour 配送',  desc:'食材当天送',              url:'https://www.carrefouruae.com',
      appStore:'https://apps.apple.com/app/id1149094249', playStore:'https://play.google.com/store/apps/details?id=com.carrefour.mafuae'},
    {emoji:'🔁', name:'菜谱 → 清单 → 买', desc:'周日定 3 道新菜 → 写采购单 → 一次买齐'},
  ],
  learning: [
    {emoji:'🦉', name:'Duolingo',        desc:'语言学习',                url:'https://www.duolingo.com',
      scheme:'duolingo://', appStore:'https://apps.apple.com/app/id570060128', playStore:'https://play.google.com/store/apps/details?id=com.duolingo'},
    {emoji:'🎓', name:'Khan Academy',    desc:'数学/科学免费课',         url:'https://www.khanacademy.org',
      appStore:'https://apps.apple.com/app/id469863705', playStore:'https://play.google.com/store/apps/details?id=org.khanacademy.android'},
    {emoji:'📺', name:'Coursera',        desc:'大学公开课',              url:'https://www.coursera.org',
      appStore:'https://apps.apple.com/app/id736535961', playStore:'https://play.google.com/store/apps/details?id=org.coursera.android'},
    {emoji:'💡', name:'得到',            desc:'中文知识音频',            url:'https://www.dedao.cn',
      appStore:'https://apps.apple.com/app/id1056316206', playStore:'https://play.google.com/store/apps/details?id=com.luojilab.player'},
  ...
  sports: [
    {emoji:'🎾', name:'SPORTSMANIA JLT', desc:'足球/网球/Padel · 步行可达',  url:'https://www.google.com/maps/search/SPORTSMANIA+JLT+Dubai'},
    {emoji:'🚴', name:'Al Qudra 骑行',   desc:'专用车道 + 湖泊 · 35min',     url:'https://www.google.com/maps/search/Al+Qudra+Cycle+Track'},
    {emoji:'🏖️', name:'JBR 跑步/SUP',     desc:'海边 · 10min',                 url:'https://www.google.com/maps/search/JBR+Beach+Dubai'},
    {emoji:'💪', name:'Keep',            desc:'居家健身视频（懒得出门）',    url:'https://www.gotokeep.com',
      appStore:'https://apps.apple.com/app/id920425220', playStore:'https://play.google.com/store/apps/details?id=com.gotokeep.keep'},
    {emoji:'🏃', name:'Strava',          desc:'跑步 / 骑行记录',             url:'https://www.strava.com',
      scheme:'strava://', appStore:'https://apps.apple.com/app/id426826309', playStore:'https://play.google.com/store/apps/details?id=com.strava'},
    {emoji:'🎵', name:'Workout 歌单',    desc:'Spotify · 燃脂节奏',          url:'https://open.spotify.com/genre/0JQ5DAtjkXrh2SbwUQzQfc',
      scheme:'spotify://', appStore:'https://apps.apple.com/app/id324684580', playStore:'https://play.google.com/store/apps/details?id=com.spotify.music'},
  ],
  family_ritual: [
    {emoji:'💬', name:'微信',            desc:'视频/文字给长辈',         url:'https://wx.qq.com',
      scheme:'weixin://', appStore:'https://apps.apple.com/app/id414478124', playStore:'https://play.google.com/store/apps/details?id=com.tencent.mm'},
    ...
    {emoji:'🍿', name:'Disney+',         desc:'家庭电影夜片单',          url:'https://www.disneyplus.com',
      scheme:'disneyplus://', appStore:'https://apps.apple.com/app/id1446075923', playStore:'https://play.google.com/store/apps/details?id=com.disney.disneyplus'},
    {emoji:'🔁', name:'家庭仪式日历',    desc:'每月固定 1 次（电影夜/桌游夜/外出夜）'},
  ],
  food: [
    {emoji:'🛵', name:'Talabat',         desc:'外卖 App',                url:'https://www.talabat.com',
      scheme:'talabat://', appStore:'https://apps.apple.com/app/id486847508', playStore:'https://play.google.com/store/apps/details?id=com.talabat'},
    {emoji:'🍽️', name:'Zomato Dubai',    desc:'餐厅评分 / 菜单',         url:'https://www.zomato.com/dubai',
      scheme:'zomato://', appStore:'https://apps.apple.com/app/id434613896', playStore:'https://play.google.com/store/apps/details?id=com.application.zomato'},
  ...
  entertainment: [
    {emoji:'🎫', name:'Klook',           desc:'景点门票折扣',            url:'https://www.klook.com/en-AE',
      scheme:'klook://', appStore:'https://apps.apple.com/app/id622879986', playStore:'https://play.google.com/store/apps/details?id=com.klook'},
